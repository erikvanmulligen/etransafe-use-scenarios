...
st.set_page_config(page_title="eTS KH test" , page_icon=None, layout='centered', initial_sidebar_state='auto')
st.markdown(
    f"""
<style>
    .stButton>button {{
...
df = []
if st.button("retreive similars") and len(compoundSmile) > 0:
